...
namespace GDK
{
	...
	public class ModuleClassMap
	{
		...
		public Func<IShare> Share = () => new ShareBase();
		...
		public Func<IFileSystem> FileSystem = () => new FileSystemBase();

		public Func<IDataAnalyze> DataAnalyze = () => new DataAnalyzeBase();

		// public Func<IHotUpdate> HotUpdate;
		// public Func<IAppPay> AppPay;
		public Func<IStorage> Storage = () => new StorageBase();
		public Func<IHardware> Hardware = () => new HardwareBase();
	}
}